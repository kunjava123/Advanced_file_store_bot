...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002221547444"))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002230080698')).split()]
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002230554372'))
